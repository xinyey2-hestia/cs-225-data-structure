...
class KDTree
{
  public:
    ...
    void helper( int l, int r,  int dimension);
    int partition( int l, int r, int middle, int d);
    void quicksort(int l, int r ,int k, int d);
    void findhelper(const Point<Dim>& target, int l, int r, double radius,int dimension, Point<Dim>& currentBest, bool& isroot)const;
